...
interface MultiSelectProps
  ...
  /**
   * If true, shows bottom buttons in the popover.
   * Optional, defaults to false.
   */
...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
  (
    ...
    const isGroupedOptions = React.useCallback(
      (opts: MultiSelectOption[] | MultiSelectGroup[]): opts is MultiSelectGroup[] => opts.length > 0 && 'heading' in opts[0],
      []
    )
        ...
        <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                'flex h-auto min-h-8 items-center justify-between rounded-md border bg-inherit p-1 hover:bg-inherit [&_svg]:pointer-events-auto',
            ...
            >
              {selectedValues.length > 0 ? (
                <div className='flex w-full items-center justify-between'>
                  ...
                  >
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      ...
                      >
                        {`+ ${selectedValues.length - responsiveSettings.maxCount}${i18n.t('ш')}`}
                        <XCircle
                ...
                <div className='mx-auto flex w-full items-center justify-between'>
                  <span className='text-muted-foreground/50 mx-3 text-sm'>{placeholder}</span>
          ...
          >
            <Command>
              {searchable && (
                <CommandInput
                  placeholder={i18n.t('Сонголтуудыг шүүх...')}
              ...
              {searchable && (
                <div id={`${multiSelectId}-search-help`} className='sr-only'>
                  {i18n.t('Шүүлтүүрийн сонголтуудыг бичих. Үр дүнг удирдахын тулд сум товчийг ашиглана уу.')}
                </div>
              )}
              <CommandList
                className={cn(
              ...
              >
                <CommandEmpty>{emptyIndicator || i18n.t('Үр дүн олдсонгүй.')}</CommandEmpty>{' '}
                        ...
                        return (
                          ...
                          >
                            <div
                              ...
                              aria-hidden='true'
                            >
                              <CheckIcon className={cn('h-3.5 w-3.5', isSelected ? 'text-white' : 'invisible')} />
                            </div>
